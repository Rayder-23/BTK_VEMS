...
public abstract class HrPlaceholderModuleControllerBase : HrBaseController
{
    protected abstract string ModuleKey { get; }

    private HrNavItem Module => HrModuleCatalog.Get(ModuleKey);
    ...
    public IActionResult Index()
    {
        ...
        return View("HrModuleIndex", HrModuleCatalog.CreateListPage(ModuleKey));
    }
    ...
    public IActionResult Create()
    {
        ...
        return View("HrModuleForm", HrModuleCatalog.CreateFormPage(ModuleKey));
    }
    ...
    public IActionResult Edit(int id)
    {
        ...
        ViewData["PageTitle"] = ViewData["Title"];
        return View("HrModuleForm", HrModuleCatalog.CreateFormPage(ModuleKey, id));
    }
