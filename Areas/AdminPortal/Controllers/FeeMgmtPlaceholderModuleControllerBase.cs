...
public abstract class FeeMgmtPlaceholderModuleControllerBase : FeeMgmtBaseController
{
    private FeeMgmtModule Module => FeeMgmtModuleCatalog.Get(ModuleKey);
    ...
    public IActionResult Index()
    {
        ...
        return View("FeeMgmtModuleIndex", FeeMgmtModuleCatalog.CreateListPage(ModuleKey));
    }
    ...
    public IActionResult Create()
    {
        ...
        return View("FeeMgmtModuleForm", FeeMgmtModuleCatalog.CreateFormPage(ModuleKey));
    }
    ...
    public IActionResult Edit(int id)
    {
        ...
        ViewData["PageTitle"] = ViewData["Title"];
        return View("FeeMgmtModuleForm", FeeMgmtModuleCatalog.CreateFormPage(ModuleKey, id));
    }
