...
[Route("adminportal/settings/teacher-courses")]
public sealed class TeacherCourseLinksController : AdminBaseController
{
    private readonly ITeacherCourseLinkRepository _teacherCourses;

    public TeacherCourseLinksController(ITeacherCourseLinkRepository teacherCourses)
    {
    ...
    {
        ViewData["Title"] = "Link teacher courses";
        ViewData["PageTitle"] = "Settings · Link teacher courses";
    ...
    public async Task<IActionResult> Create(CancellationToken cancellationToken)
    {
        ...
        ViewData["PageTitle"] = "Settings · Add teacher course link";
    ...
    public async Task<IActionResult> Edit(int id, CancellationToken cancellationToken)
    {
        ...
        ViewData["PageTitle"] = "Settings · Edit teacher course link";
