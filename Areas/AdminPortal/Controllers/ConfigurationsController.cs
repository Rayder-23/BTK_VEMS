...
[Route("adminportal/settings/configurations")]
public sealed class ConfigurationsController : AdminBaseController
{
    private readonly IConfigurationsRepository _configurations;

    public ConfigurationsController(IConfigurationsRepository configurations)
    {
    ...
    public async Task<IActionResult> Index(CancellationToken cancellationToken)
    {
        ...
        ViewData["PageTitle"] = "Settings · Configurations";
    ...
    public IActionResult Create()
    {
        ...
        ViewData["PageTitle"] = "Settings · Configurations · Add";
    ...
    public async Task<IActionResult> Edit(int id, CancellationToken cancellationToken)
    {
        ...
        ViewData["PageTitle"] = "Settings · Configurations · Edit";
    ...
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, ConfigurationFormModel model, CancellationToken cancellationToken)
    {
        ViewData["Title"] = "Edit configuration";
        ViewData["PageTitle"] = "Settings · Configurations · Edit";
